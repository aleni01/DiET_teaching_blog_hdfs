                                      ...
                                      >
                                        <div className="flex flex-wrap gap-1 mt-2 p-2 bg-zinc-50 rounded-lg">
                                          {file.blocks.map((block) => (
                                            <div
                                              key={block.id}
                                              className="w-3 h-4 rounded-sm shadow-sm border border-black/5"
                                              style={{
                    ...
                    <div key={file.id} className="space-y-2">
                      ...
                      <div className="pl-4 space-y-1">
                        {file.blocks.map((block) => (
                          ...
                          >
                            <div
                              className="w-2 h-3 rounded-sm border border-black/5"
        ...
        <div className="pt-4 border-t border-zinc-100 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-zinc-50 p-3 rounded-xl border border-zinc-100">
              <p className="text-[9px] font-bold uppercase tracking-wider text-zinc-400 mb-1">
                Total Blocks
              </p>
